...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?= base_url() ?>/theme/css/adminlte.min.css">
    <!-- Login Style -->
    <link rel="stylesheet" href="<?= base_url() ?>/theme/css/login.css">
</head>

<body class="hold-transition login-page log_p">
    <div class="row log_b">
        <div class="col-lg-6 d-none d-lg-block bg-login-image"></div>
        <div class="col-lg-6">
            <div class="login-box">
                <!-- /.login-logo -->
                <div class="card card-outline card-primary log">
    ...
    <!-- Bootstrap 4 -->
    <script src="<?= base_url() ?>/theme/js/bootstrap.bundle.min.js"></script>
    <!-- AdminLTE App -->
    <script src="<?= base_url() ?>/theme/js/adminlte.min.js"></script>
