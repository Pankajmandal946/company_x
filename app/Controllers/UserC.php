            ...
            if(isset($request) && !empty($request)) {
                ...
                if(isset($request->action)) {
                    if($request->action=='add') {
                        ...
                        $user->user_designation_id = $request->user_designation_id;
                        $user->seniority_by_years = $request->seniority_by_years;
                        ...
                        $user->created_by = $_SESSION['rsp_user_id'];
                        ...
                        if($user->check() === false) {
                            ...
                            if($request->login_access==1) {
                                ...
                                $user_login->created_by = $_SESSION['rsp_user_id'];
                                $user_login->updated_by = $_SESSION['rsp_user_id'];
                        ...
                        foreach($results as $res) {
                            ...
                            $result[] = [
                                ...
                                'seniority_by_years'    => $res['seniority_by_years'],
                                'user_designation'      => $res['user_designation'],
                                'father_name'           => $res['father_name'],
                                'email_personal'        => $res['email_personal'],
